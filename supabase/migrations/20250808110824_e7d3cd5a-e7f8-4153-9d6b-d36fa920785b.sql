...
-- Expand registration_tracking status options for better history
ALTER TYPE public.registration_status ADD VALUE IF NOT EXISTS 'cadastro_criado';
ALTER TYPE public.registration_status ADD VALUE IF NOT EXISTS 'documentos_solicitados';
ALTER TYPE public.registration_status ADD VALUE IF NOT EXISTS 'documento_aprovado';
ALTER TYPE public.registration_status ADD VALUE IF NOT EXISTS 'documento_rejeitado';
ALTER TYPE public.registration_status ADD VALUE IF NOT EXISTS 'aprovado_final';
ALTER TYPE public.registration_status ADD VALUE IF NOT EXISTS 'rejeitado_final';
...
-- Add index for better performance on messages
CREATE INDEX idx_messages_social_registration ON public.messages(social_registration_id, created_at DESC);
